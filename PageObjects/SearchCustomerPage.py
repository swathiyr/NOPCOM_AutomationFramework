class SearchCustomer():
    ...
    tblSearchResults_xpath="//table[@role='grid']" #Selects entire table
    table_xpath="//table[@id='customers-grid']"
    tableRows_xpath="//table[@id='customers-grid']//tbody/tr" # selects all rows
    tableColumns_xpath="//table[@id='customers-grid']//tbody/tr/td" # selects all columns
